...
class easy_install(Command):
    ...
    user_options = [
        ...
        ('force-installation-into-system-dir', '0',
...
""")
        ...
        try:
            ...
            try:
                ...
                if os.name == 'nt':
                    ...
                    use_alt = (basename.lower() == 'python.exe' and
                               os.path.exists(alt))
                    if use_alt:
        ...
        if not self.exclude_scripts and dist.metadata_isdir('scripts'):
            for script_name in dist.metadata_listdir('scripts'):
                if dist.metadata_isdir('scripts/' + script_name):
                    ...
                    continue
                self.install_script(dist, script_name,
    ...
    def install_item(self, spec, download, tmpdir, deps, install_needed=False):
        ...
        install_needed = install_needed or (
            ...
            os.path.dirname(normalize_path(download)) == normalize_path(
    ...
    if sys.version[:3] in ('2.3', '2.4',
                           '2.5') or 'real_prefix' in sys.__dict__:
...
def main(argv=None, **kw):
    ...
    with _patch_usage():
        setup(script_args=['-q', 'easy_install', '-v'] + argv,
