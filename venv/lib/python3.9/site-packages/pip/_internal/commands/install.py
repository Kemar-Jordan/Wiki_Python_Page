...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options, args):
        ...
        if (not options.use_user_site and not options.prefix_path and
                not options.target_dir and not options.use_system_location):
        ...
        if options.target_dir:
            ...
            if (os.path.exists(options.target_dir) and
        ...
        try:
            ...
            should_warn_about_conflicts = (not options.ignore_dependencies and
